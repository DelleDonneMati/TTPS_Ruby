...
#imprima en pantalla la cantidad de caracteres que tiene su representación como String y 
#la representación que se utilizó para contarla.
...
def longitud (*args)
	puts args.map { |arg| "#{arg} = #{arg.to_s.length}" }
end
